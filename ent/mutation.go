...
func (m *RestaurantMutation) SetLocation(s *schema.Point) {
	m.location = &s
}

// Location returns the value of the "location" field in the mutation.
func (m *RestaurantMutation) Location() (r *schema.Point, exists bool) {
	v := m.location
	if v == nil {
		return
	}
...
// OldLocation returns the old "location" field's value of the Restaurant entity.
// If the Restaurant object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RestaurantMutation) OldLocation(ctx context.Context) (v *schema.Point, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RestaurantMutation) ResetLocation() {
	m.location = nil
}
...
func (m *RestaurantMutation) Fields() []string {
	...
	if m.location != nil {
		fields = append(fields, restaurant.FieldLocation)
	}
	return fields
}
